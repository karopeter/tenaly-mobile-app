...
export default function PostKidFeedingForm() {
    ...
    const getDropdownData = () => {
        ...
        if (categoryStr.includes('Feeding (bottles, high chairs, breast pumps)')) {
           return {
            ...baseDropdowns
           };
        }
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post For baby Feeding Ad' : 'Post For baby Feeding Ad'}
        </Text>
      </View>
     </View>
