...
export default function PostBeautyHairForm() {
   ...
   const getDropdownData = () => {
    ...
    const baseDropdowns: Record<string, string[]> = {
      ...
      hairType: ['All Hair Types', 'Natural', 'Relaxed', 'Curly', 'Wavy', 'Coily'],
    };

    if (categoryStr.includes('Hair Care')) {
      return {
        ...baseDropdowns
      };
    }
   ...
   useEffect(() => {
    const fetchDraftData = async () => {
      ...
      try {
       if (!apiClient)  return;
        console.log('Fetching draft for carAdId:', draftCarAdId);
        ...
        hairType: beautyAd.hairType || '',
        gender: beautyAd.gender || '',
        beautyBrand: beautyAd.beautyBrand || '',
        amount: beautyAd.amount?.toString() || '',
      ...
      <View style={styles.header}>
         ...
         <TouchableOpacity onPress={() => router.back()}>
          ...
          <Text style={styles.headerTitle}>
            {isDraftMode ? 'Complete Haircare Ad' : 'Post Haircare Ad'}
          </Text>
         </View>
      </View>
      ...
      >
        ...
        <View style={styles.row}>
         <PostAdDropdown
           ...
           onPress={() => openDropdown('hairType', 'Select Hair Type')}
         />
        </View>
