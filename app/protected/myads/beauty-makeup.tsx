...
export default function PostBeautyMakeupForm() {
   ...
   const getDropdownData = () => {
    ...
    if (categoryStr.includes('Makeup & Cosmetics')) {
      return {
        ...baseDropdowns
      };
    }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
         ...
         {/* <Text style={styles.headerTitle}>Post Makeup & Cosmetics Ad</Text> */}
         <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Makeup Cosmetics' : 'Post Makeup & Cosmetics Ad'}
         </Text>
         </View>
      </View>
      ...
      >
        ...
        <View style={styles.row}>
         <PostAdDropdown
           ...
           onPress={() => openDropdown('skinTone', 'Select Hair Type')}
         />
        </View>
