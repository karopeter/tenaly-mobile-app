...
export default function PostBeautyBathForm() {
   ...
   const getDropdownData = () => {
    ...
    const baseDropdowns: Record<string, string[]> = {
      ...
      skinType: ['Dry', 'Sensitive', 'Fragrance-Free', 'Normal', 'All', 'Oily'],
    };

    if (categoryStr.includes('Bath & Body')) {
      return {
        ...baseDropdowns
      };
    }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
         ...
         {/* <Text style={styles.headerTitle}>Post Bath & Body Ad</Text> */}
          <Text style={styles.headerTitle}>
            {isDraftMode ? 'Complete Bath & Body Ad' : 'Post Bath & Body Ad'}
          </Text>
         </View>
      </View>
