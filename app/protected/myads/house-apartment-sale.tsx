...
export default function HouseApartmentSaleForm() {
   const router = useRouter();
   const params = useLocalSearchParams();
   const { cateory, plan, paymentMethod, carAdId} = params;
   ...
   const [formData, setFormData] = useState({
     ...
     description: '',
       ...
       const dropdownData: Record<string, string[]> = {
         ...
         propertyCondition: ["Newly Built", "Off  plan", "Uncomplete buiding", "under construction"],
         propertyDuration: ["! Mo  nth", "3 Months", "6 Months", "1 Year", "2 Years", "Negotiable"],
         negotiation: ["Yes", "No"],
         ...
         numberOfToilet: ["1-Toilet", "2-Toilet", "3-Toilet", "4-Toilet"],
           titleDocuments: [
        ...
        >
          ...
          <View style={styles.row}>
            ...
            <PostAdDropdown
               ...
               value={formData.numberOfToilet}
               onPress={() => openDropdown('numberOfToilet', 'numberOfToilet')}
            />
          </View>
