...
export default function PostHouseholdKitchewareForm() {
    ...
    const getDropdownData = () => {
        ...
        if (categoryStr.includes('Kitchenware & Cookware')) {
           return {
            ...baseDropdowns
           };
        }
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Kitchenware & Cookware Ad' : 'Post Kitchenware & Cookware Ad'}
        </Text>
      </View>
     </View>
