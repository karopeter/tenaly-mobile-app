...
export default function AgricultureFertilizersForm() {
    ...
    if (categoryStr.includes('Fertilizers')) {
      return {
        ...
        agricultureType: [
          ...
          'DAP', 
          'Compost', 
          'Inorganice / Chemical Fertilizer',
          'Biofertilizer',
        ...
        unit: ['kg', 'bags', 'Cup', 'Derica', 'Paint bucket', 'Pieces'],
        brand: ['Dangote Fertilizer', 'Golden Fertilizer', 'Indorama', 'Custom Mix', 'Others']
      };
    }
   ...
   <View style={styles.container}>
    ...
    <View style={styles.headerContainer}>
      ...
      <Text style={styles.headerTitle}>
        {isDraftMode ? 'Complete your Fertilizer Ad' : 'Post Fertilizer Ad'}
      </Text>
    </View>
    </View>
    ...
    >
     ...
     <View style={styles.row}>
      <PostAdInput
        label="Title"
        placeholder="E.g NPK 15-15 Fertilizer"
     ...
     {dropdownData.brand && (
        <View style={styles.row}>
         <PostAdDropdown
           ...
           onPress={() => openDropdown('brand', 'Select Unit')}
         />
        </View>
     )}
