...
export default function PostBeautyGroomingForm() {
   ...
   const getDropdownData = () => {
    ...
    if (categoryStr.includes('Personal Grooming Devices')) {
      return {
        ...baseDropdowns
      };
    }
         ...
         <TouchableOpacity onPress={() => router.back()}>
           ...
           {/* <Text style={styles.headerTitle}>Post Personal Grooming Devices Ad</Text> */}
            <Text style={styles.headerTitle}>
              {isDraftMode ? 'Complete Personal Grooming Devices Ad' : 'Post Personal Grooming Devices Ad'}
            </Text>
         </View>
      </View>
