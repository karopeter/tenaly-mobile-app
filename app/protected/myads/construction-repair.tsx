...
export default function PostConstructionPlumbingForm() {
                  ...
                  const fetchDraftData = async () => {
                    ...
                    try {
                     ...
                     setFormData({
                       ...
                       experienceLevel: constructionAd.experienceLevel || '',
                       constructionAvailability: constructionAd.constructionAvailability || '',
     ...
     const submitAd = async (plan: string, useWallet: boolean) => {
        try {
          ...
          const payload = {
            ...
            constructionAvailiability: formData.constructionAvailability,
 ...
 const startPaymentPolling = (reference: string) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.constructionTitle  || !formData.constructionType || !formData.experienceLevel || !formData.amount) {
         showErrorToast('Please fill all required fields (constructionTitle, experienceLevel, constructionType, amount)');
         return;
    }
  ...
  const handleSaveAsDraft = async () => {
    ...
    try {
     ...
     const payload = {
      ...
      constructionType: formData.constructionType,
      experienceLevel: formData.experienceLevel,
      constructionAvailability: formData.constructionAvailability,
      amount: formData.amount,
      negotiation: formData.negotiation,
      description: formData.description,
    ...
    <View style={styles.container}>
      <View style={styles.header}>
       <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Repair & Maintenance Services Ad' : 'Post Repair & Maintenance Services Ad'}
        </Text>
       </View>
      </View>
      ...
      >
        ...
        <View style={styles.row}>
         <PostAdDropdown
           label='Availability'
           value={formData.constructionAvailability}
           onPress={() => openDropdown('constructionAvailability', 'Select')}
         />
        </View>
