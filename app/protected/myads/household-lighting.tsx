...
export default function PostHouseholdLighteningForm() {
    ...
    const getDropdownData = () => {
        ...
        if (categoryStr.includes('Lighting')) {
           return {
            ...baseDropdowns
           };
        }
                    ...
                    const fetchDraftData = async () => {
                      ...
                      try {
                       ...
                       setFormData({
                        ...
                        powerType: householdAd.powerType || '',
                        condition: householdAd.condition || '',
                        householdBrand: householdAd.householdBrand || '',
                        colorTemperature: householdAd.colorTemperature || '',
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Lighting Ad' : 'Post Lighting Ad'}
        </Text>
      </View>
     </View>
     ...
     >
       ...
       <View style={styles.row}>
        <PostAdInput
          ...
          placeholder='Enter'
          onChangeText={(value) => updateField('householdBrand', value)}
        />
       </View>
       ...
       <View style={styles.row}>
         <PostAdDropdown
           ...
           onPress={() => openDropdown('colorTemperature', 'Select')}
         />
       </View>
