...
export default function AgricultureFarmForm() {
  ...
  return (
   <View style={styles.container}>
    ...
    <View style={styles.headerContainer}>
      ...
      {/* <Text style={styles.headerTitle}>Post Farm Tools & Equipment Ad</Text> */}
      <Text style={styles.headerTitle}>
        {isDraftMode ? 'Complete Farm Tools & Equipment Ad' : 'Post Farm Tools & Equipment Ad'}
      </Text>
    </View>
    </View>
