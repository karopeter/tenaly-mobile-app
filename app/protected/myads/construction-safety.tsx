...
export default function PostConstructionPlumbingForm() {
                      ...
                      const fetchDraftData = async () => {
                        ...
                        try {
                         ...
                         setFormData({
                           ...
                           constructionMaterial: constructionAd.constructionMaterial || '',
     ...
     const submitAd = async (plan: string, useWallet: boolean) => {
        try {
          ...
          const payload = {
            ...
            constructionColor: formData.constructionColor,
 ...
 const startPaymentPolling = (reference: string) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.constructionTitle  || !formData.constructionType || !formData.constructionMaterial || !formData.amount) {
         showErrorToast('Please fill all required fields (constructionTitle, constructionMaterial, constructionType, amount)');
         return;
    }
      ...
      <View style={styles.header}>
       <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Safety Equipment & Workwear Ad' : 'Post Safety Equipment & Workwear Ad'}
        </Text>
       </View>
      </View>
      ...
      >
        ...
        <View style={styles.row}>
          <PostAdDropdown
            label="Material"
            value={formData.condition}
            onPress={() => openDropdown('constructionMaterial', 'Select')}
          />
        </View>
        ...
        <View style={styles.row}>
         <PostAdDropdown
           label="Color"
           value={formData.constructionColor}
           onPress={() => openDropdown('constructionColor', 'Select')}
         />
        </View>
