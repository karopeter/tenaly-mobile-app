...
export default function PostHouseholdGardenForm() {
   ...
   const [isDraftMode, setIsDraftMode] = useState(false);
    ...
    const getDropdownData = () => {
        ...
        if (categoryStr.includes('Garden & Outdoor')) {
           return {
            ...baseDropdowns
           };
        }
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Garden & Outdoor Ad' : 'Post Garden & Outdoor Ad'}
        </Text>
      </View>
     </View>
     ...
     >
       ...
       <View style={styles.row}>
        <PostAdInput
          ...
          placeholder="Enter"
          onChangeText={(value) => updateField('householdPowerSource', value)}
        />
       </View>
