...
export default function PostFashionWeddingEventForm() {
    ...
    const getDropdownData = () => {
        ...
        if (categoryStr.includes('Wedding & Event Wear')) {
           return {
            ...baseDropdowns
           };
        }
      ...
      const fetchDraftData = async () => {
        ...
        try {
         ...
         setFormData({
           ...
           size: fashionAd.size || '',
           fashionMaterial: fashionAd.fashionMaterial || '',
    ...
    const submitAd = async (plan: string, useWallet: boolean) => {
        try {
         ...
         const payload = {
           ...
           size: formData.size,
           fashionMaterial: formData.fashionMaterial,
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Clothing Ad' : 'Post Clothing Ad'}
        </Text>
      </View>
     </View>
     ...
     >
      ...
      <View style={styles.row}>
        <PostAdDropdown
          label="Size"
          value={formData.size}
          onPress={() => openDropdown('size', 'Select')}
        />
      </View>
      ...
      <View style={styles.row}>
       <PostAdDropdown
         label="Material"
         value={formData.fashionMaterial}
         onPress={() => openDropdown('fashionMaterial', 'Select')}
       />
      </View>
