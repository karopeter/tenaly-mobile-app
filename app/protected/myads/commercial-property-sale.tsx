...
export default function CreateCommercialPropertySaleForm() {
    ...
    const dropdownData: Record<string, string[]> = {
      ...
      parking: ["Available", "Not Available", "Available Nearby"],
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Commercial property for sale Ad' : 'Post a Commercial property for sale Ad'}
        </Text>
        </View>
        <View style={{ width: 24 }} />
      </View>
      ...
      >
       ...
       <View style={styles.row}>
        ...
        />
        <PostAdDropdown
         label="Are you the owner or agent of the property"
