...
export default function PostBeautyMakeupForm() {
   ...
   const getDropdownData = () => {
    ...
    const baseDropdowns: Record<string, string[]> = {
      ...
      skinTone: ['Fair', 'Universal', 'Dark'],
      fragranceFamily: ['Floral', 'Fruity', 'Woody', 'Fresh', 'Oriental', 'Spicy', 'Musky', 'Citrus']
    };

    if (categoryStr.includes('Fragrances (Perfume & Body Spray)')) {
      return {
        ...baseDropdowns
      };
    }
     ...
     const fetchDraftData = async () => {
       ...
       try {
        ...
        setFormData({
          ...
          fragranceFamily: beautyAd.fragranceFamily || '',
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
         ...
         {/* <Text style={styles.headerTitle}>Post Fragrances Ad</Text> */}
         <Text style={styles.headerTitle}>
           {isDraftMode ? 'Complete Fragrances Ad' : 'Post Fragrances Ad'}
         </Text>
         </View>
      </View>
      ...
      >
        ...
        <View style={styles.row}>
         <PostAdDropdown
           ...
           onPress={() => openDropdown('fragranceFamily', 'Select Hair Type')}
         />
        </View>
