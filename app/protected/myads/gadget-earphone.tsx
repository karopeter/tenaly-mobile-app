   ...
   const [isDraftMode, setIsDraftMode] = useState(false);
    ...
    const getDropdownData = () => {
        ...
        const baseDropdowns: Record<string, string[]> = { 
          ...
          connectivityType: ['Wired', 'Wireless', 'Bluetooth', 'USB-C', 'Lightning']
        };

        if (categoryStr.includes('Earphones / Headsets')) {
           return {
            ...baseDropdowns
           };
        }
            ...
            return;
                ...
                try {
                 ...
                 setFormData({
                  ...
                  connectivityType: gadgetAd.connectivityType || '',
    ...
    const submitAd = async (plan: string, useWallet: boolean) => {
        try {
         ...
         const payload = {
          ...
          connectivityType: formData.connectivityType ? formData.connectivityType.split(', ') : [],
 ...
 const handleSaveAsDraft = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        gadgetBrand: formData.gadgetBrand,
        storageCapacity: formData.storageCapacity,
       connectivityType: Array.isArray(formData.connectivityType) 
        ? formData.connectivityType
        : formData.connectivityType
        ? formData.connectivityType.split(", ").map((f) => f.trim())
        : [],
        gadgetColor: formData.gadgetColor,
        accessories: formData.accessories,
        warranty: formData.warranty,
     ...
     >
      ...
      <View style={styles.row}>
        <PostAdInput
          ...
          onChangeText={(value) => updateField('storageCapacity', value)}
        />
      </View>
      ...
      <View style={styles.row}>
        <MultiSelectDropdown
          ...
          selectedValues={formData.connectivityType ? formData.connectivityType.split(', '): []}
          options={[
            'Wired',
            'Wireless',
            'Bluetooth',
          ...
          onChange={(values) => 
            updateField('connectivityType', values.join(', '))
          }
        />
      </View>
