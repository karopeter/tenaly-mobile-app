...
export default function PetAccessorieForm() {
 ...
 const getDropdownData = () => {
    ...
    if (categoryStr.includes('Pet Accessories')) {
        return {
          ...baseDropdowns,
          breed: ['Labrador', 'German Shepherd', 'Golden Retriever', 'Bulldog', 'Beagle', 'Poodle'],
       ...
       <View style={styles.header}>
        <View style={styles.headerContainer}>
         ...
         <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Pet Accessories Pet Ad' : 'Post Pet Accessories Pet Ad'}
         </Text>
        </View>
       </View>
