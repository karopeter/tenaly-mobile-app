   ...
   const [walletBalance, setWalletBalance] = useState(0);
    ...
    const getDropdownData = () => {
        ...
        const baseDropdowns: Record<string, string[]> = {
           ...
           finish: ['Matte', 'Glossy', 'Semi-gloss', 'Satin', 'Others']
        };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.row}>
         ...
         {/* Constructuion Finish */}
          <View style={styles.row}>
            <PostAdDropdown
              label="Finish"
              value={formData.finish}
              onPress={() => openDropdown('finish', 'Select')}
            />
          </View>
          ...
          <View style={styles.row}>
           <PostAdInput 
             ...
             onChangeText={(value) => updateField('constructionColor', value)}
           />
          </View>
