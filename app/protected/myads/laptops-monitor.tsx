...
export default function PostLaptopMonitorForm() {
    ...
    const getDropdownData = () => {
        ...
        const baseDropdowns: Record<string, string[]> = { 
           ...
           laptopScreenSize: ['19 Inches', '21 Inches', '24 Inches', '27 Inches', '32 Inches', '34 Inches'],
           resolution: ['HD', 'Full HD', '2K', '4K'], 
           refreshRate: ['60HZ', '75Hz', '120Hz', '144Hz+'],
           warranty: ['No Warranty', '3 Months', '6 Months', '1 Year', 'More than 1 Year'],
        };

        if (categoryStr.includes('Monitors')) {
           return {
            ...baseDropdowns
           };
        }
      ...
      const fetchDraftData = async () => {
        ...
        try {
         ...
         setFormData({
          ...
          resolution: laptopAd.resolution || '',
          refreshRate: laptopAd.refreshRate || '',
    ...
    const submitAd = async (plan: string, useWallet: boolean) => {
        try {
         ...
         const payload = {
          ...
          laptopScreenSize: formData.laptopScreenSize,
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Monitor Ad' : 'Post Monitor Ad'}
        </Text>
      </View>
     </View>
     ...
     >
      ...
      <View style={styles.row}>
        <PostAdDropdown
          ...
          onPress={() => openDropdown('resolution', 'Select')} 
        />
      </View>
      ...
      <View style={styles.row}>
        <PostAdDropdown
          ...
          onPress={() => openDropdown('refreshRate', 'Select')}
        />
      </View>
