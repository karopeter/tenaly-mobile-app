...
export default function PostConstructionEletricalForm() {
      ...
      const fetchDraftData = async () => {
        ...
        try {
         ...
         setFormData({
           ...
           powerRating: constructionAd.powerRating || '',
           warranty: constructionAd.warranty || '',
      ...
      <View style={styles.header}>
       <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Building Materials Ad' : 'Post Building Materials Ad'}
        </Text>
       </View>
      </View>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.row}>
           <PostAdInput
             ...
             placeholder="Enter"
             onChangeText={(value) => updateField('powerRating', value)}
            />
        </View>
