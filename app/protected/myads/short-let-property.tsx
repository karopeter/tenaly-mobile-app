...
export default function ShortletForm() {
   ...
   const [formData, setFormData] = useState({
     ...
     description: '',
       ...
       const dropdownData: Record<string, string[]> = {
         ...
         negotiation: ["Yes", "No"],
         isSmokingAllowed: ["Yes", "No"],
         isPartiesAllowed: ["Yes", "No"],
         petsAllowed: ["Yes", "No"],
         numberOfBedrooms: ["1-Bedroom Flat", "2-Bedroom Flat", "3-Bedroom Flat", "4-Bedroom Flat"],
         numberOfBathrooms: ["1-Bathroom", "2-Bathroom", "3-Bathroom", "4-Bathroom"],
         numberOfToilets: ["1-Toilet", "2-Toilet", "3-Toilet", "4-Toilet"],
       };
          ...
          <View style={styles.row}>
           ...
           />
            <PostAdDropdown
              ...
              onPress={() => openDropdown('petsAllowed', 'petsAllowed')}
            />
          </View>
          ...
          <View style={styles.row}>
           ...
           <View style={styles.row}>
             <PostAdInput
               ...
               placeholder="Enter"
               value={formData.maximumAllowedGuest}
               onChangeText={(value) => updateField('maximumAllowedGuest', value)}
             />
             <PostAdDropdown
               label="Number of Bedrooms"
               value={formData.numberOfBedrooms}
               onPress={() => openDropdown('numberOfBedrooms', 'numberOfBedrooms')}
             />
           </View>
           ...
           <View style={styles.row}>
             <PostAdDropdown
              ...
              onPress={() => openDropdown('numberOfBathrooms', 'numberOfBathrooms')}
             />

             <PostAdDropdown
              label="Number of Toilets"
              value={formData.numberOfToilets}
              onPress={() => openDropdown('numberOfToilets', 'numberOfToilets')}
             />
           </View>
           ...
           <View style={styles.row}>
             <PostAdDropdown
                ...
                onPress={() => openDropdown('isSmokingAllowed', 'isSmokingAllowed')}
             />
              <PostAdDropdown
                label="Is parties allowed?"
                value={formData.isPartiesAllowed}
                onPress={() => openDropdown('isPartiesAllowed', 'isPartiesAllowed')}
             />
           </View>
