...
export default function PostLaptopDesktopForm() {
    ...
    const getDropdownData = () => {
        ...
        const baseDropdowns: Record<string, string[]> = { 
           ...
           warranty: ['No Warranty', '3 Months', '6 Months', '1 Year', 'More than 1 Year'],
           laptopStorage: ['8 GB', '16 GB', '32 GB', '64 GB', '128 GB', '256 GB', '512 GB', '1 TB'],
           laptopRam: ['1 GB', '2 GB', '4 GB', '8 GB', '16 GB', '32 GB'],
           laptopOperating: ['Chromse OS', 'Harmony OS', 'Linux', 'MacOS', 'Windows'],
           laptopScreenSize: ['11-13', '14-15.6', '16-17.3'],
        };

        if (categoryStr.includes('Desktop Computers')) {
           return {
            ...baseDropdowns
           };
        }
          ...
          const fetchDraftData = async () => {
            ...
            try {
             ...
             setFormData({
              ...
              laptopProcessor: laptopAd.laptopProcessor || '',
              laptopRam: laptopAd.laptopRam || '',
              laptopStorage: laptopAd.laptopStorage || '',
              laptopOperating: laptopAd.laptopOperating || '',
              laptopScreenSize: laptopAd.laptopScreenSize || '',
              laptopBatteryHealth: laptopAd.laptopBatteryHealth || '',
              laptopColor: laptopAd.laptopColor || '',
              laptopAccessories: laptopAd.laptopAccessories || '',
             ...
             showSuccessToast('Draft loaded! Complete ad details.');
            } catch (error: any) {
   ...
   const fetchUserProfile = async () => {
    ...
    const submitAd = async (plan: string, useWallet: boolean) => {
        try {
         ...
         const payload = {
          laptopTitle: formData.laptopTitle,
          condition: formData.condition,
          laptopBrand: formData.laptopBrand,
          laptopProcessor: formData.laptopProcessor,
          laptopRam: formData.laptopRam,
          laptopStorage: formData.laptopStorage,
          laptopOperating: formData.laptopOperating,
          laptopBatteryHealth: formData.laptopBatteryHealth,
          laptopColor: formData.laptopColor,
          laptopAccessories: formData.laptopAccessories,
         ...
         const response = await apiClient.post('/api/laptops/create-laptop-ad', payload);

         console.log('✅ Response:', response.data);

         if (response.data.data.paymentStatus === 'success') {
            showSuccessToast('Laptop ad posted successfully!');
 ...
 const startPaymentPolling = (reference: string) => {
  ...
  const pollInterval = setInterval(async () => {
    ...
    try {
      ...
      const verifyResponse = await apiClient.get(`/api/laptops/verify-payment/${reference}`);
...
const handleSubmit = async () => {
   ...
   if (!formData.laptopTitle || !formData.condition || !formData.laptopBrand || !formData.amount) {
     showErrorToast('Please fill all required fields (laptopTitle, condition, laptopBrand, amount)');
     return;
   }
 ...
 const handleSaveAsDraft = async () => {
    ...
    try {
      ...
      const response = await apiClient.post('/api/laptops/save-draft', payload);
    ...
    <View style={styles.container}>
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Laptop Ad' : 'Post Laptop Ad'}
        </Text>
      </View>
     </View>
     ...
     >
       ...
       <View style={styles.row}>
          <PostAdInput
            label="Title"
            value={formData.laptopTitle}
            placeholder='Enter Title'
            onChangeText={(value) => updateField('laptopTitle', value)}
          />
       </View>
      ...
      <View style={styles.row}>
       <PostAdInput
         ...
         onChangeText={(value) => updateField('laptopBrand', value)}
       />
      </View>
      ...
      <View style={styles.row}>
       <PostAdInput
         ...
         onChangeText={(value) => updateField('laptopProcessor', value)}
       />
      </View>
      ...
      <View style={styles.row}>
        <PostAdDropdown
          ...
          onPress={() => openDropdown('laptopRam', 'Select')}
        />
      </View>
      ...
      <View style={styles.row}>
       <PostAdDropdown
         ...
         value={formData.laptopStorage}
         onPress={() => openDropdown('laptopStorage', 'Select')}
       />
      </View>
      ...
      <View style={styles.row}>
       <PostAdDropdown
         ...
         value={formData.laptopOperating}
         onPress={() => openDropdown('laptopOperating', 'Select')}
       />
      </View>
      ...
      <View style={styles.row}>
       <PostAdDropdown
         label="Screen Size"
         value={formData.laptopScreenSize}
         onPress={() => openDropdown('laptopScreenSize', 'Select')}
       />
      </View>
      ...
      <View style={styles.row}>
          <PostAdInput
            ...
            value={formData.laptopBatteryHealth}
            placeholder='e.g 92%'
            onChangeText={(value) => updateField('laptopBatteryHealth', value)}
          />
      </View>
       ...
       <View style={styles.row}>
        <PostAdInput
          ...
          value={formData.laptopAccessories}
          placeholder="e.g charger, Bag, Mouse, Others"
          onChangeText={(value) => updateField('laptopAccessories', value)}
          />
       </View>
       ...
       <View style={styles.row}>
         <PostAdInput 
           label="Color"
           value={formData.laptopColor}
           placeholder="Enter"
           onChangeText={(value) => updateField('laptopColor', value)}
         />
       </View>
      ...
      <View style={styles.row}>
        <PostAdDropdown
          ...
          onPress={() => openDropdown('warranty', 'Select')}
        />
      </View>
