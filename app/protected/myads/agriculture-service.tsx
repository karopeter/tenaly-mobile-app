...
export default function AgricultureServicesForm() {
  ...
  const getDropdownData = () => {
    ...
    if (categoryStr.includes('Farm Services')) {
      return {
        ...
        serviceMode: ['On-site', 'Remote', 'On-Sit & Remote'],
        experienceLevel: ['Beginner', 'Intermediate', 'Expert'],
        brand: ['Bayer', 'Dangote', 'UPL', 'Syngeta', 'NPK', 'Others'],
        availability: ["Full-Time", "Part-Time", "On Request"]
      };
    }
   ...
   <View style={styles.container}>
    ...
    <View style={styles.headerContainer}>
      ...
      <Text style={styles.headerTitle}>
        {isDraftMode ? 'Complete Farm Services Ad' : 'Post Farm Services Ad'}
      </Text>
    </View>
    </View>
    ...
    >
     ...
     {/* Service Mode */}
        <View style={styles.row}>
         <MultiSelectDropdown
           label="Service Mode"
           selectedValues={formData.serviceMode ? formData.serviceMode.split(', '): []}
           onChange={(values) => 
            updateField('serviceMode', values.join(', '))
           }
           options={[
             "On-Site",
             "Remote",
     ...
     {dropdownData.availability && (
       <View style={styles.row}>
         <PostAdDropdown
          ...
          onPress={() => openDropdown('availability', 'Select Availability')}
         />
       </View>
     )}
