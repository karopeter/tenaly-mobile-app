...
export default function PostLaptopNetworkingForm() {
   ...
   const [isDraftMode, setIsDraftMode] = useState(false);
    ...
    const getDropdownData = () => {
        ...
        const baseDropdowns: Record<string, string[]> = { 
           ...
           laptopBrand: ['Apple', 'ASUS', 'HP', 'Dell', 'Lenovo', 'Toshiba'],
           speedRating: ['2-Port', '4-Port', '8-Port', '16-Port', '24-Port', '48-Port'],
           warranty: ['No Warranty', '3 Months', '6 Months', '1 Year', 'More than 1 Year'],
        };

        if (categoryStr.includes('Networking Equipment')) {
           return {
            ...baseDropdowns
           };
        }
      ...
      const fetchDraftData = async () => {
        ...
        try {
         ...
         setFormData({
          ...
          speedRating: laptopAd.speedRating || '',
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Networking Equipment Ad' : 'Post Networking Equipment Ad'}
        </Text>
      </View>
     </View>
     ...
     >
       ...
       <View style={styles.row}>
         <PostAdDropdown
           ...
           onPress={() => openDropdown('laptopType', 'Select')}
         />
       </View>
      ...
      <View style={styles.row}>
       <PostAdDropdown
        ...
        onPress={() => openDropdown('laptopBrand', 'Select')}
       />
      </View>
      ...
      <View style={styles.row}>
        <PostAdDropdown
          ...
          onPress={() => openDropdown('speedRating', 'Select')}
        />
      </View>
