...
export default function BusinessDelivery() {
  const [businessDelivery, setBusinessDelivery] = useState<BusinessDelivery[]>([]);
     ...
     const EmptyState = () => (
       ...
       const renderTabContent = () => {
        ...
        case 'delivery': 
         ...
         ): businessDelivery.length === 0 ? (
            <EmptyState />
         ): (
           <View>
            {/* Business Delivery list will go here when implemented */}
           </View>
         );
    case 'hours':
           return (
            <View  style={styles.tabContentContainer}>
              <Text style={styles.tabContentText}>Business Hours</Text>
            </View>
           );
         default: 
         return null;
