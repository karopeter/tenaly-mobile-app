...
export default function PostHouseholdDecorForm() {
    ...
    const getDropdownData = () => {
        ...
        if (categoryStr.includes('Home Decor')) {
           return {
            ...baseDropdowns
           };
        }
    ...
    const submitAd = async (plan: string, useWallet: boolean) => {
        try {
         ...
         const payload = {
           ...
           householdStyle: formData.householdStyle,
    ...
    <View style={styles.container}>
     ...
     >
       ...
       <View style={styles.row}>
         <PostAdDropdown
           label="Style"
           value={formData.householdStyle}
           onPress={() => openDropdown('householdStyle', 'Select')}
         />
       </View>
