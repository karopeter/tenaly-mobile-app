...
export default function PostKidShoeForm() {
    ...
    const getDropdownData = () => {
        ...
        const baseDropdowns: Record<string, string[]> = { 
           ...
           ageGroup: ['Newborn (0-6 months)', 'Infant (6-12 months)', 'Toddler (1-3 years', 'Child (4-7 years)', 'Older Kids (8-12 years'],
           size: ['XS', 'S', 'M', 'L', 'XL', 'XXL', 'XXXL', 'XXXXL']
        };

        if (categoryStr.includes('Shoes')) {
           return {
            ...baseDropdowns
           };
        }
    ...
    <View style={styles.container}>
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Post For Shoes Ad</Text>
      </View>
     </View>
