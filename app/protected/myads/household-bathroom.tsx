...
export default function PostHouseholdBathroomForm() {
    ...
    const getDropdownData = () => {
        ...
        if (categoryStr.includes('Bathroom Accessories')) {
           return {
            ...baseDropdowns
           };
        }
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Bathroom Accessories  Ad' : 'Post Bathroom Accessories  Ad'}
        </Text>
      </View>
     </View>
