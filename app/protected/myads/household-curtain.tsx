...
export default function PostHouseholdCurtainsForm() {
    ...
    const getDropdownData = () => {
        ...
        if (categoryStr.includes('Curtains & Blinds')) {
           return {
            ...baseDropdowns
           };
        }
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Curtains & Blinds Ad' : 'Post Curtains & Blinds Ad'}
        </Text>
      </View>
     </View>
