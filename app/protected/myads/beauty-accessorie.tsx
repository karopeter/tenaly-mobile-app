...
export default function PostBeautyAccessoriesForm() {
   ...
   const getDropdownData = () => {
    ...
    const baseDropdowns: Record<string, string[]> = {
      ...
      beautyPowerSource: ['Eletric', 'Rechargeable', 'Battery'],
    };

    if (categoryStr.includes('Beauty Tools & Accessories')) {
      return {
        ...baseDropdowns
      };
    }
   ...
   useEffect(() => {
     const fetchDraftData = async () => {
       ...
       try {
        ...
        console.log('Draft loaded:', beautyAd);
        ...
        setFormData({
          ...
          beautyPowerSource: beautyAd.beautyPowerSource || '',
  ...
  const submitAd = async (plan: string, useWallet: boolean) => {
     try {
      ...
      const payload = {
         ...
         beautyPowerSource: formData.beautyPowerSource,
    ...
    <View style={styles.container}>
      <View style={styles.header}>
         ...
         <TouchableOpacity onPress={() => router.back()}>
           ...
           {/* <Text style={styles.headerTitle}>Post Personal Grooming Devices Ad</Text> */}
            <Text style={styles.headerTitle}>
              {isDraftMode ? 'Complete Personal Gromming Device Ad' : 'Post Personal Grooming Devices Ad'}
            </Text>
         </View>
      </View>
      ...
      >
        ...
        <View style={styles.row}>
          <PostAdDropdown
            label="Power Source"
            value={formData.beautyPowerSource}
            onPress={() => openDropdown('beautyPowerSource', 'Select Power Source')}
          />
        </View>
