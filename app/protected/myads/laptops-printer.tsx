...
export default function PostLaptopPrinterForm() {
    ...
    const getDropdownData = () => {
        ...
        if (categoryStr.includes('Printers & Scanners')) {
           return {
            ...baseDropdowns
           };
        }
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Printers & Scanners Ad' : 'Post Printers & Scanners Ad'}
        </Text>
      </View>
     </View>
