...
export default function PostKidSchoolForm() {
    ...
    const getDropdownData = () => {
        ...
        const baseDropdowns: Record<string, string[]> = { 
           ...
           ageGroup: ['Nursery', 'Primary 1-3', 'Primary 4-6', 'Junior Secondary', 'Senior Secondary']
        };

        if (categoryStr.includes('School Supplies (bags, books, stationery)')) {
           return {
            ...baseDropdowns
           };
        }
...
const handleSubmit = async () => {
   ...
   if (!formData.title || !formData.condition || !formData.kidsType || !formData.amount) {
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post For Health & Safety Ad' : 'Post For Health & Safety Ad'}
        </Text>
      </View>
     </View>
     ...
     >
       ...
       <View style={styles.row}>
         <PostAdDropdown
          ...
          onPress={() => openDropdown('ageGroup', 'Select')}
         />
       </View>
