                ...
                if (isDraft) {
                  return (
                    <>
                      ...
                      style={styles.modalOption}
                       onPress={() => {
                        ...
                        const carAdId = selectedAd?.carAd?._id;
                        const adCategory = selectedAd?.carAd?.category;

                        if (!carAdId) {
                          showErrorToast('Draft ID not found');
                          return;
                        }

                        console.log('📝 Completing draft:', { carAdId, category: adCategory });
                    ...
                    'MC / Host Services': '/protected/myads/jobs-mc-services',
                     ...
                     // Laptop and computer categories 
                     ...
                     'Others': '/protected/myads/laptops-others',
                        ...
                        const formPath = categoryRoutes[adCategory];
                        ...
                        if (formPath) {
                          ...
                          showErrorToast(`Form not found for category: ${adCategory}`);
                          console.log('❌ Missing route for category:', adCategory);
                        }
                       }}
                      >
