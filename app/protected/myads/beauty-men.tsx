...
export default function PostBeautyMenForm() {
   ...
   const getDropdownData = () => {
    ...
    if (categoryStr.includes("Men's Grooming")) {
      return {
        ...baseDropdowns
      };
    }
   ...
   useEffect(() => {
     const fetchDraftData = async () => {
       ...
       try {
        ...
        showSuccessToast('Draft loaded! Compolete your ad details.');
       } catch (error: any) { 
...
const startPaymentPolling = (reference: string) => {
 ...
 const handleSubmit = async () => {
    ...
    if (!formData.beautyTitle || !formData.beautyBrand || !formData.amount) {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
         ...
         <TouchableOpacity onPress={() => router.back()}>
           ...
           {/* <Text style={styles.headerTitle}>Post Men`s Grooming Ad</Text> */}
            <Text style={styles.headerTitle}>
              {isDraftMode ? "Complete Men's Grooming Ad" : 'Post Men`s Grooming Ad'}
            </Text>
         </View>
      </View>
