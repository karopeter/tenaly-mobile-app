...
export default function PostHouseholdFurnitureForm() {
    ...
    const getDropdownData = () => {
        ...
        if (categoryStr.includes('Furniture')) {
           return {
            ...baseDropdowns
           };
        }
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post Furniture Ad' : 'Post Furniture Ad'}
        </Text>
      </View>
     </View>
     ...
     >
       ...
       <View style={styles.row}>
         <PostAdDropdown
           ...
           onPress={() => openDropdown('roomType', 'Select')}
         />
       </View>
