...
export default function AgricultureProductForm() {
   ...
   <View style={styles.container}>
    ...
    <View style={styles.headerContainer}>
      ...
      <Text style={styles.headerTitle}>
        {isDraftMode ? 'Complete Agriculture & Food Ad' : 'Post an Agriculture & Food Ad'}
      </Text>
    </View>
    </View>
    ...
    >
     ...
     >
      ...
      {/* Description */}
        <PostAdTextArea
          label="Description"
          placeholder="Fresh-harvested tomatoes from Joo farms, packed in 50kg baskets. Organically grown without chemical fertilizers"
