...
export default function PostKidGearForm() {
    ...
    const getDropdownData = () => {
        ...
        const baseDropdowns: Record<string, string[]> = { 
            negotiation: ["Yes", "No"],
            kidsType: ['Stroller', 'Car Seat', 'Baby Carrier', 'Baby Walker', 'Baby Bouncer', 'High Chair', 'Baby Swing', 'Potty Training Seat', 'Others'],
           condition: ['Brand New', 'Fairly Used'],
           gender: ['Male', 'Female', 'Unisex'],
        };

        if (categoryStr.includes('Baby Gear (strollers, car seats, carriers)')) {
           return {
            ...baseDropdowns
           };
        }
     ...
     <View style={styles.header}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>
          {isDraftMode ? 'Complete Post For Baby Gear Ad' : 'Post For Baby Gear Ad'}
        </Text>
      </View>
     </View>
